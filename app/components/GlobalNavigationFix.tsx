  ...
  useEffect(() => {
    ...
    const openServices = async () => {
      ...
      const icons: Record<string, string> = {
        services_repair: '🔧', services_cleaning: '🧹', services_design: '🎨', services_construction: '🏗️', services_furniture: '🪑', services_plumbing: '🚿', services_electric: '⚡', services_moving: '🚚', services_other: '🛠️', services_landscape: '🌳', services_cctv: '📹', services_ac_installation: '❄️',
      }
...
`
      ...
      const render = () => {
        ...
        const items: ServiceItem[] = active === 'home'
          ...
          : active === 'finance' ? finance : interactive
