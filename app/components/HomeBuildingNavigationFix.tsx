...
const mortgageIcons = [
  ...
  '<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M9 53h46M14 53V28l18-16 18 16v25" fill="none" stroke="currentColor" stroke-width="3.5"/><path d="M25 53V38h14v15M8 28h48" fill="none" stroke="currentColor" stroke-width="3.5"/><path d="m43 14 5 5-10 10" fill="none" stroke="currentColor" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  '<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M9 54h46M14 54V29l18-16 18 16v25" fill="none" stroke="currentColor" stroke-width="3.5" stroke-linejoin="round"/><path d="M25 54V39h14v15" fill="none" stroke="currentColor" stroke-width="3.5"/><path d="m43 18 8 8-4 4-8-8 4-4Z" fill="none" stroke="currentColor" stroke-width="3.5" stroke-linejoin="round"/><path d="m36 25 4-4" stroke="currentColor" stroke-width="3.5" stroke-linecap="round"/></svg>',
...
export default function HomeBuildingNavigationFix() {
  useEffect(() => {
    const polishAfterRender = () => {
      window.requestAnimationFrame(() => polishMortgageIcons())
    }
