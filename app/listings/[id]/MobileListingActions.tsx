    ...
    >
      <div className="mx-auto grid max-w-xl grid-cols-2 gap-3">
        ...
        <button
          ...
          className="min-h-12 rounded-2xl border border-slate-300 bg-white px-4 py-3 text-sm font-black text-slate-900 transition active:scale-[0.98] disabled:opacity-60"
