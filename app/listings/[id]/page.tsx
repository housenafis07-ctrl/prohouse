...
export default function ListingDetailPage() {
  ...
  return <main className="min-h-screen bg-[#f6f7f8] text-slate-900">
    ...
    <div className="mx-auto max-w-[1200px] px-4 py-6 sm:px-6">
      ...
      <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm"><div className="grid lg:grid-cols-[1.35fr_.65fr]"><div className="bg-slate-100">{images.length ? <img src={images[0].image_url} alt={title} className="h-[420px] w-full object-cover sm:h-[520px]"/> : <div className="flex h-[420px] items-center justify-center text-slate-400">Rasm mavjud emas</div>}</div>
