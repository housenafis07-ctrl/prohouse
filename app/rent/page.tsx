...
const items = [
  ...
  { key: 'commercial', icon: '🏬', uz: 'Tijorat ko‘chmas mulki', ru: 'Коммерческая недвижимость', subUz: 'Ofis, do‘kon va boshqa tijorat obyektlari', subRu: 'Офисы, магазины и другие объекты', href: '/listings?tab=rent&taxonomy=rent_commercial' },
  { key: 'dacha', icon: '🏡', uz: 'Dacha', ru: 'Дачи', subUz: 'Dam olish uchun uylar va hovlilar', subRu: 'Дачи и загородные дома для отдыха', href: '/listings?tab=rent&taxonomy=rent_dacha' },
]
