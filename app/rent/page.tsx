...
const items = [
  ...
  { key: 'dacha', icon: '🏡', uz: 'Dachalar', ru: 'Дачи', subUz: 'Dam olish uchun dachalar, bo‘sh kunlar va bronlash', subRu: 'Дачи для отдыха, свободные даты и бронирование', href: '/listings?tab=rent&type=house&taxonomy=rent_dacha' },
]
