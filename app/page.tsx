...
export default function Home() {
  ...
  return <main>
    ...
    <section id="partners" className="container partners"><span>{lang==='uz'?'Hamkorlar uchun':'Для партнёров'}</span><div><b>IPOTEKA BANK</b><b>HAMKORBANK</b><b>TBC BANK</b><b>XALQ BANKI</b><b>KAPITALBANK</b></div></section>
    <section id="post-listing" className="container cta"><div><span className="muted-label">{text.sellerKicker}</span><h2>{text.sellerTitle}</h2><p>{text.sellerText}</p></div><button className="green-btn" type="button">{text.post} →</button></section>
