-- Preserve seller_type for existing owner listings. The column is NOT NULL in
-- production, while the edit form intentionally leaves ownership_type empty for
-- most rental listings.
